...
<section class="container">
	<div class="centrar"><h1>Marketing</h1></div>	
	<hr>	
<%@include file="opciones.jsp" %>
<input name="area" type="hidden" value="marketing" />
	<div class="col-md-offset-1 col-md-5">
		<h3>Ingresos</h3>
		<form action="Controlador_ingresos" method="get">
                <input type="hidden" name="area_ingreso" value="marketing" />
	...
	<div class="col-md-offset-0 col-md-5">
		...
		<form action="Controlador_gastos" method="get">
                <input type="hidden" name="area_gasto" value="marketing" />
